...
# AppDeploy POC Deployment Platform Demo Script
...
show_intro() {
    clear
    title "AppDeploy POC Deployment Platform Demo"
    cat << 'EOF'

\033[3m_                  ____             _             
    / \   _ __  _ __   |  _ \  ___ _ __ | | ___  _   _ 
  / _ \ | '_ \| '_ \  | | | |/ _ \ '_ \| |/ _ \| | | |
 / ___ \| |_) | |_) | | |_| |  __/ |_) | | (_) | |_| |
/_/   \_\ .__/| .__/  |____/ \___| .__/|_|\___/ \__, |
          |_|   |_|                |_|            |___/ \033[0m
                  POC Deployment Platform

EOF
    
    echo -e "${CYAN}Welcome to the AppDeploy POC Demo!${NC}"
    echo ""
...
deploy_platform() {
    title "Deploying AppDeploy POC Platform"
...
EOF
    ...
    kubectl get pods,svc -n $DEMO_NAMESPACE -l demo=appdeploy
...
show_monitoring_integration() {
    ...
    echo "The AppDeploy platform provides comprehensive monitoring:"
    echo ""
...
open_platform_dashboard() {
    title "Accessing AppDeploy POC Dashboard"
    ...
    echo ""
    log "Opening AppDeploy POC Dashboard..."
...
demonstrate_gitops_integration() {
    ...
    log "AppDeploy seamlessly integrates with your existing GitOps workflow..."
    
    subtitle "ArgoCD Applications"
    echo "All applications deployed through AppDeploy are managed by ArgoCD:"
...
cleanup_demo() {
    ...
    echo ""
    echo -e "${CYAN}The AppDeploy POC platform remains deployed and ready for use.${NC}"
...
main() {
    case "${1:-full}" in
        ...
        full)
            ...
            ;;
        *)
            echo "AppDeploy POC Deployment Platform Demo"
            echo ""
